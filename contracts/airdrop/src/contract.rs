...
pub fn instantiate(
    ...
    let config = Config {
        ...
        airdrop_snip20_optional: msg.airdrop_token_optional.clone(),
...
pub fn execute(deps: DepsMut, env: Env, info: MessageInfo, msg: ExecuteMsg) -> StdResult<Response> {
    pad_handle_result(
        match msg {
            ...
            ExecuteMsg::Claim { amount, eth_pubkey, eth_sig, proof, .. } => try_claim(deps, &env, &info, amount, eth_pubkey, eth_sig, proof),
